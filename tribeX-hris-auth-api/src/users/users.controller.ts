...
export class UsersController {
  ...
  // ---- /me routes -------------------------------------------------------
  // IMPORTANT: All /me and /me/* routes MUST be declared before /:id.
  // NestJS matches routes in declaration order; if @Get(':id') comes first,
  // it will greedily capture the literal string "me" as a dynamic param,
  // causing GET /users/me, PATCH /users/me, and all /users/me/* endpoints
  // to silently fail or return wrong data.
  // -----------------------------------------------------------------------
  ...
  // ---- Dynamic :id routes — MUST come after all literal-path routes ----
