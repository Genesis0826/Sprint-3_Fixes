  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([p, changeReqs]) => {
        ...
        const ext: ExtendedProfile = { phone: p.phone_number ?? "", personalEmail: p.personal_email ?? "", address: p.complete_address ?? "", dob: p.date_of_birth ?? "", placeOfBirth: p.place_of_birth ?? "", nationality: p.nationality ?? "", civilStatus: p.civil_status ?? "" };
        setExtended(ext);
  ...
  const handleExtendedSave = async () => {
    ...
    try {
      await updateEmployeeProfile({
        phone_number:     extendedDraft.phone.trim() || undefined,
        personal_email:   extendedDraft.personalEmail.trim() || undefined,
        date_of_birth:    extendedDraft.dob || undefined,
        place_of_birth:   extendedDraft.placeOfBirth.trim() || undefined,
        nationality:      extendedDraft.nationality.trim() || undefined,
        civil_status:     extendedDraft.civilStatus || undefined,
        complete_address: extendedDraft.address.trim() || undefined,
      });
